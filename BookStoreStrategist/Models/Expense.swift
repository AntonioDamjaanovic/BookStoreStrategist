...
struct Expense: Identifiable {
    ...
    static var example = Expense(title: "Rent", category: .fixed, amount: 2000, expenseDate: Date(timeIntervalSinceNow: -7_200_000))
    ...
    static var yearExamples: [Expense] = {
        ...
        for month in 1...12 {
            for _ in 1...10 {
                ...
                let date = formatter.date(from: "2026/\(month)/\(randomDay)")!
